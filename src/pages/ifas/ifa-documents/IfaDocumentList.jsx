...
import { removeDocs } from "../../../redux/features/ifa/ifaSlice";

import styles from "./ifadocumentlist.module.scss";

const IfaDocumentList = ({ handleClose, popupData }) => {
    const {
        docs,
...
export default IfaDocumentList;
