...
import styles from "./openticketreplay.module.scss";
  ...
  return (
    ...
    <div className={styles.MainContainer}>
      <div className={styles.Header}>
        ...
        <div className={styles.buttonHeader}><button className={styles.HeaderButton1} onClick={()=>handleClose()}>Back</button>
            ...
            {data.replyBy !== 3&&<>
              <div className={styles.Chatbox1}>
                ...
                <div className={styles.ChatboxLeft}>
                  <span className={styles.ChatboxLeftHeading}>{t(`Replied by user`)}</span>
           ...
           {data.replyBy === 3&&<>
              <div className={styles.Chatbox2}>
                <div className={styles.ChatboxLeft2}>
                  <p className={styles.ChatboxLeftHeading2}>{t(`Replied by admin`)}</p>
