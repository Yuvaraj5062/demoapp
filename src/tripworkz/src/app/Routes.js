...
import { WerkzcreditSuccess } from "./modules/SuccessPages/WerkzcreditSuccess";
        ...
        <Switch>
            ...
            {!isAuthorized ? (
                ...
                location.pathname=="/voucheraccept"?
                        <Route path="/voucheraccept" component={AcceptRejectPromocode} />
                        :
                <Layout userType={auth.user.userType}>
                    {
