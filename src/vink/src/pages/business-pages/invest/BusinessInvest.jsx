...
import { investBusinessData, titleContentData } from "../../../data/data";
import styles from "./businessinvest.module.scss";
import Button from "../../../components/button/Button";
import PlanCard from "../../../components/plan-card/PlanCard";

const BusinessInvest = () => {
  return (
    <>
      <div className={styles.mainContainer}>
        ...
        <div className={styles.cardDisplayRow}>
          {investBusinessData.map((item, index) => {
            return (
              <PlanCard
                item={item}
                key={index}
