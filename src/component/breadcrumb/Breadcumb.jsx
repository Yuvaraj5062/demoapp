        ...
        for (let i = 0; i < routeData.length; i++) {
            if (routeData[i].breadcrumb && routeData[i].location === path) {
                ...
                for (let j = 0; j < routeData[i].children.length; j++) {
                    ...
                    else if (routeData[i].children[j].children) {
                        for (let k = 0; k < routeData[i].children[j].children.length; k++) {
                            if (routeData[i].children[j].children[k].location === path) {

                                setState(routeData[i].children[j].breadcrumb)
                                return routeData[i].children[j].children[k].breadcrumb
                            }
                        }

                    } else if (!isNaN(path.split('/')[2])) {
